...
class Player:
    """
    The Player class represents the characters in the game like :py:class:`gamedemo.weapons.Weapon`
    ...
    def take_hit(self, damage):
        ...
        :param damage: The damage dealt. This will be subtracted from :attr:`health`.
